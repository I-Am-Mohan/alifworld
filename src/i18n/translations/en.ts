export const en = {
  ...
  sellerProfile: {
    ...
    returnPolicy: 'Return policy',
    cancellationPolicy: 'Cancellation policy',
    publicContacts: 'Public contact controls',
    publicEmail: 'Show support email publicly',
    publicPhone: 'Show support phone publicly',
    publicPickup: 'Show pickup district publicly',
    uploadBranding: 'Upload branding',
    brandingUploaded: 'Branding asset uploaded successfully.',
    brandingFailed: 'Unable to upload branding asset.',
    payoutProfile: 'Payout profile',
    payoutProvider: 'Bank or payout provider',
    payoutAccount: 'Account number',
    payoutRouting: 'Routing number (optional)',
    payoutTitle: 'Account title',
    payoutSave: 'Save payout profile',
    payoutMasked: 'Current payout account',
    payoutPending: 'Pending verification',
    payoutSecurity: 'Banking details are encrypted and never displayed in full.',
    payoutFailed: 'Unable to save payout profile.',
  ...
  sellerKyc: {
    ...
    loadFailed: 'Unable to load KYC documents.',
    viewFailed: 'Unable to open secure document view.',
    fileRequired: 'Select a document and provide the seller ID.',
    documents: 'Submitted documents',
    empty: 'No KYC documents have been submitted.',
    type: 'Document type',
    file: 'File metadata',
    status: 'Status',
    view: 'Secure view',
  ...
  sellerApplication: {
    ...
    description: 'Submit your business details to start the seller approval process.',
    businessName: 'Business name',
    slug: 'Store URL handle',
    ...
    reviewReason: 'Reviewer message',
    loadFailed: 'Unable to load your seller application.',
    saveFailed: 'Unable to save your seller application.',
    submitFailed: 'Unable to submit your seller application.',
    signInRequired: 'Please sign in to apply as a seller.',
    noApplication: 'Start your seller application below.',
    statuses: {
      DRAFT: 'Draft',
      SUBMITTED: 'Submitted',
  ...
  auth: {
    ...
    passwordMaxLength: 'No more than 128 characters',
    passwordUppercase: 'One uppercase English letter (A-Z)',
    passwordLowercase: 'One lowercase English letter (a-z)',
    passwordNumber: 'One number (0-9)',
    passwordSpecial: 'One special character (!@#$%^&*...)',
    passwordUnique: 'Choose a password that is not common or breached',
  ...
  admin: {
    ...
    kycReviewSuccess: 'KYC document updated successfully.',
    kycView: 'Secure view',
    kycVerify: 'Verify document',
    kycReject: 'Reject document',
    applicationsTab: 'Applications',
    kycTab: 'KYC documents',
    review: 'Review',
    approve: 'Approve',
    reject: 'Reject',
