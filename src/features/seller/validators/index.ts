...
export const UpdateStoreSettingsInputSchema = z.object({
  ...
  logoObjectKey: z.never().optional(),
  bannerObjectKey: z.never().optional(),
  storeDescription: z.string().trim().max(2000).nullable().optional(),
  shippingPolicy: z.string().trim().max(4000).nullable().optional(),
  returnPolicy: z.string().trim().max(4000).nullable().optional(),
  cancellationPolicy: z.string().trim().max(4000).nullable().optional(),
  publicEmailEnabled: z.boolean().optional(),
  publicPhoneEnabled: z.boolean().optional(),
  publicPickupAddressEnabled: z.boolean().optional(),
