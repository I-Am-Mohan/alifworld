...
title: "Build the production multi-stage Docker image"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 281: Build the production multi-stage Docker image

## Outcome

Implement **Build the production multi-stage Docker image** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 29, **DevOps, Deployment, and Observability**. The phase purpose is: Package, deploy, observe, and safely roll back the application and workers.
...
- Previous: [280 - Run UAT against the approved business configuration matrix](280-run-uat-against-the-approved-business-configuration-matrix.md)
- Next: [282 - Build Docker Compose and external-infrastructure profiles](282-build-docker-compose-and-external-infrastructure-profiles.md)
...
- Use a non-root runtime, reproducible lockfile installs, health checks, and minimal production layers.
...
- [ ] The implementation of **Build the production multi-stage Docker image** is real, reachable where intended, and contains no fake success path.
