...
title: "Build initial indexing and incremental search-index jobs"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 112: Build initial indexing and incremental search-index jobs

## Outcome

Implement **Build initial indexing and incremental search-index jobs** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 12, **Search, Discovery, SEO, and Storefront**. The phase purpose is: Build fast localized discovery while keeping search optional and SEO first-class.
...
- Previous: [111 - Create the Meilisearch-independent search abstraction](111-create-the-meilisearch-independent-search-abstraction.md)
- Next: [113 - Implement filters, facets, sorting, pagination, and typo tolerance](113-implement-filters-facets-sorting-pagination-and-typo-tolerance.md)
...
- [ ] The implementation of **Build initial indexing and incremental search-index jobs** is real, reachable where intended, and contains no fake success path.
