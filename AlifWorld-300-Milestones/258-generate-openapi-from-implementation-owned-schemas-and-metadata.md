...
title: "Generate OpenAPI from implementation-owned schemas and metadata"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 258: Generate OpenAPI from implementation-owned schemas and metadata

## Outcome

Implement **Generate OpenAPI from implementation-owned schemas and metadata** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 26, **REST API, OpenAPI, and Flutter Contracts**. The phase purpose is: Make implementation-owned schemas produce stable versioned REST and automated documentation.
...
- Previous: [257 - Complete Rider and Delivery APIs for Flutter consumption](257-complete-rider-and-delivery-apis-for-flutter-consumption.md)
- Next: [259 - Publish Swagger UI, examples, authentication flows, and error catalogs](259-publish-swagger-ui-examples-authentication-flows-and-error-catalogs.md)
...
- Use one schema source for runtime validation and documentation.
- Fail CI when generated OpenAPI is stale or invalid.
- Include request, success, pagination, authorization, and machine-readable error examples.
...
- [ ] The implementation of **Generate OpenAPI from implementation-owned schemas and metadata** is real, reachable where intended, and contains no fake success path.
