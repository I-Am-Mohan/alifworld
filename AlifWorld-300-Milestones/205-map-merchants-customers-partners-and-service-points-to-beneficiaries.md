...
title: "Map merchants, customers, partners, and service points to beneficiaries"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 205: Map merchants, customers, partners, and service points to beneficiaries

## Outcome

Implement **Map merchants, customers, partners, and service points to beneficiaries** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 21, **Regional Distribution and Commissions**. The phase purpose is: Allocate rule-versioned Alif Point and Alif Pay commissions through Bangladesh geography.
...
- Previous: [204 - Import and maintain Bangladesh geographic hierarchy](204-import-and-maintain-bangladesh-geographic-hierarchy.md)
- Next: [206 - Implement Alif Point Division, District, and Upazila commission rules](206-implement-alif-point-division-district-and-upazila-commission-rules.md)
...
- [ ] The implementation of **Map merchants, customers, partners, and service points to beneficiaries** is real, reachable where intended, and contains no fake success path.
