...
title: "Implement the Cash on Delivery provider"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 152: Implement the Cash on Delivery provider

## Outcome

Implement **Implement the Cash on Delivery provider** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 16, **Payments and Seller Finance**. The phase purpose is: Integrate payment providers behind stable interfaces and reconcile every external event.
...
- Previous: [151 - Define the payment-provider interface and capability matrix](151-define-the-payment-provider-interface-and-capability-matrix.md)
- Next: [153 - Create Bangladesh payment adapters for approved local gateways](153-create-bangladesh-payment-adapters-for-approved-local-gateways.md)
...
- [ ] The implementation of **Implement the Cash on Delivery provider** is real, reachable where intended, and contains no fake success path.
