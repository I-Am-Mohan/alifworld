...
title: "Implement the configurable 3 percent Customer Rank Bonus"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [186 - Implement Customer Daily, Weekly, Monthly, and Yearly Star leaderboards](186-implement-customer-daily-weekly-monthly-and-yearly-star-leaderboards.md)
- Next: [188 - Model legacy Customer career ranks and non-cash incentives separately](188-model-legacy-customer-career-ranks-and-non-cash-incentives-separately.md)
...
- [ ] The implementation of **Implement the configurable 3 percent Customer Rank Bonus** is real, reachable where intended, and contains no fake success path.
