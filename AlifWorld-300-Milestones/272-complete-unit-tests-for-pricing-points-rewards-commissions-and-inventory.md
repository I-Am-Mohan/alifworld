...
title: "Complete unit tests for pricing, Points, rewards, commissions, and inventory"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 272: Complete unit tests for pricing, Points, rewards, commissions, and inventory

## Outcome

Implement **Complete unit tests for pricing, Points, rewards, commissions, and inventory** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 28, **Testing, Security, Compliance, and Quality**. The phase purpose is: Validate business math, journeys, privacy, accessibility, and attack resistance before launch.
...
- Previous: [271 - Build deterministic test factories, fixtures, clocks, and provider fakes](271-build-deterministic-test-factories-fixtures-clocks-and-provider-fakes.md)
- Next: [273 - Complete integration tests for authentication and catalog](273-complete-integration-tests-for-authentication-and-catalog.md)
...
- Use atomic conditional updates or database locks for reservations.
- Available equals on-hand minus active reservations, never a client-supplied value.
- Every change requires a typed movement and source reference.
...
- [ ] The implementation of **Complete unit tests for pricing, Points, rewards, commissions, and inventory** is real, reachable where intended, and contains no fake success path.
