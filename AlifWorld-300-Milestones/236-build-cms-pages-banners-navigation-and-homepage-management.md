...
title: "Build CMS pages, banners, navigation, and homepage management"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 236: Build CMS pages, banners, navigation, and homepage management

## Outcome

Implement **Build CMS pages, banners, navigation, and homepage management** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 24, **Admin, CMS, Support, and Analytics**. The phase purpose is: Give authorized operators complete control without direct database manipulation.
...
- Previous: [235 - Build payment, wallet, rewards, commission, and payout consoles](235-build-payment-wallet-rewards-commission-and-payout-consoles.md)
- Next: [237 - Build support tickets, disputes, notes, and service-level tracking](237-build-support-tickets-disputes-notes-and-service-level-tracking.md)
...
- Let Admin manage corporate profile, mission, vision, country operations, live/upcoming projects, and service lines such as hotel, hospital, restaurant, super shop, travel, agriculture, and online services as localized CMS content.
- These corporate claims and future projects are content, not automatically implemented commerce domains; label availability accurately.
...
- [ ] The implementation of **Build CMS pages, banners, navigation, and homepage management** is real, reachable where intended, and contains no fake success path.
