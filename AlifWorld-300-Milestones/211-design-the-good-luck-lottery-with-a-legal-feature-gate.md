...
title: "Design the Good-Luck lottery with a legal feature gate"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [210 - Build the Distribution Admin dashboard and end-to-end reconciliation](210-build-the-distribution-admin-dashboard-and-end-to-end-reconciliation.md)
- Next: [212 - Build lottery campaigns, ticket sales, and Good-Luck Wallet debits](212-build-lottery-campaigns-ticket-sales-and-good-luck-wallet-debits.md)
...
- The Good-Luck module uses Customer Good-Luck Wallet balance for tickets and remains disabled until approval.
- Separate it from package-coupon weekly draws and from ordinary e-commerce coupons.
...
- [ ] The implementation of **Design the Good-Luck lottery with a legal feature gate** is real, reachable where intended, and contains no fake success path.
