...
title: "Define Product Point terminology, units, and invariants"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 171: Define Product Point terminology, units, and invariants

## Outcome

Implement **Define Product Point terminology, units, and invariants** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 18, **Product Points Engine**. The phase purpose is: Treat Product Points as an independent, immutable, order-snapshotted unit with reversible ledger events.
...
- Previous: [170 - Complete wallet reconciliation, invariants, and audit tests](170-complete-wallet-reconciliation-invariants-and-audit-tests.md)
- Next: [172 - Enforce mandatory seller-defined Product Points on sellable products](172-enforce-mandatory-seller-defined-product-points-on-sellable-products.md)
...
- [ ] The implementation of **Define Product Point terminology, units, and invariants** is real, reachable where intended, and contains no fake success path.
