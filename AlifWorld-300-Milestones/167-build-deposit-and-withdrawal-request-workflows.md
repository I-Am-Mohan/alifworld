...
title: "Build deposit and withdrawal request workflows"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 167: Build deposit and withdrawal request workflows

## Outcome

Implement **Build deposit and withdrawal request workflows** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 17, **Wallet Ledger**. The phase purpose is: Implement immutable balanced wallet accounting rather than mutable counters.
...
- Previous: [166 - Implement Seller wallet permissions and settlement restrictions](166-implement-seller-wallet-permissions-and-settlement-restrictions.md)
- Next: [168 - Implement versioned wallet-split templates totaling 100 percent](168-implement-versioned-wallet-split-templates-totaling-100-pct.md)
...
- [ ] The implementation of **Build deposit and withdrawal request workflows** is real, reachable where intended, and contains no fake success path.
