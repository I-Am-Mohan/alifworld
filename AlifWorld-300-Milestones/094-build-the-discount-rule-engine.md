...
title: "Build the discount rule engine"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 094: Build the discount rule engine

## Outcome

Implement **Build the discount rule engine** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 10, **Pricing, Tax, and Promotions**. The phase purpose is: Centralize all authoritative money calculations and preserve calculation snapshots.
...
- Previous: [093 - Implement configurable tax and VAT calculation architecture](093-implement-configurable-tax-and-vat-calculation-architecture.md)
- Next: [095 - Build coupon lifecycle, eligibility, and redemption controls](095-build-coupon-lifecycle-eligibility-and-redemption-controls.md)
...
- [ ] The implementation of **Build the discount rule engine** is real, reachable where intended, and contains no fake success path.
