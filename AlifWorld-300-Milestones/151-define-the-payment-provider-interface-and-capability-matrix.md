...
title: "Define the payment-provider interface and capability matrix"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 151: Define the payment-provider interface and capability matrix

## Outcome

Implement **Define the payment-provider interface and capability matrix** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 16, **Payments and Seller Finance**. The phase purpose is: Integrate payment providers behind stable interfaces and reconcile every external event.
...
- Previous: [150 - Build disputes, support linkage, and order reporting](150-build-disputes-support-linkage-and-order-reporting.md)
- Next: [152 - Implement the Cash on Delivery provider](152-implement-the-cash-on-delivery-provider.md)
...
- [ ] The implementation of **Define the payment-provider interface and capability matrix** is real, reachable where intended, and contains no fake success path.
