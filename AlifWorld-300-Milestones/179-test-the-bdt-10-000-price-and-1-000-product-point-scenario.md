...
title: "Test the BDT 10,000 price and 1,000 Product Point scenario"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 179: Test the BDT 10,000 price and 1,000 Product Point scenario

## Outcome

Implement **Test the BDT 10,000 price and 1,000 Product Point scenario** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 18, **Product Points Engine**. The phase purpose is: Treat Product Points as an independent, immutable, order-snapshotted unit with reversible ledger events.
...
- Previous: [178 - Build order-to-Point traceability and reporting](178-build-order-to-point-traceability-and-reporting.md)
- Next: [180 - Build Point reconciliation, replay, and integrity diagnostics](180-build-point-reconciliation-replay-and-integrity-diagnostics.md)
...
- Prove that BDT 10,000 and 1,000 Points remain separate, quantity two generates 2,000 eligible Points, and later product edits do not change the order snapshot.
- Cover partial cancellation, return, duplicate events, and reversal/re-award policy.
...
- [ ] The implementation of **Test the BDT 10,000 price and 1,000 Product Point scenario** is real, reachable where intended, and contains no fake success path.
