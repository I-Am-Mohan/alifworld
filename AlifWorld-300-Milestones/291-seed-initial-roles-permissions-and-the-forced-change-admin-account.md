...
title: "Seed initial roles, permissions, and the forced-change Admin account"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 291: Seed initial roles, permissions, and the forced-change Admin account

## Outcome

Implement **Seed initial roles, permissions, and the forced-change Admin account** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 30, **Launch, Handover, and Continuous Improvement**. The phase purpose is: Seed, migrate, verify, launch, and hand over an operable Bangladesh production system.
...
- Previous: [290 - Implement release, canary, rollback, and versioning procedures](290-implement-release-canary-rollback-and-versioning-procedures.md)
- Next: [292 - Seed the reference reward configuration without hard-coding behavior](292-seed-the-reference-reward-configuration-without-hard-coding-behavior.md)
...
- Seed roles, permissions, settings, and an Admin using `SEED_ADMIN_EMAIL` and `SEED_ADMIN_PASSWORD` defaults only for local setup.
- Hash with Argon2id, force password change, and print no plaintext secret.
...
- [ ] The implementation of **Seed initial roles, permissions, and the forced-change Admin account** is real, reachable where intended, and contains no fake success path.
