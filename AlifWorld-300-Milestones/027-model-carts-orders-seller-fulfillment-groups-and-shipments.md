...
title: "Model carts, orders, seller fulfillment groups, and shipments"
status: completed
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 027: Model carts, orders, seller fulfillment groups, and shipments

## Outcome

Implement **Model carts, orders, seller fulfillment groups, and shipments** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 03, **Data Architecture**. The phase purpose is: Build a production PostgreSQL/Prisma model that preserves history, tenant boundaries, and financial traceability.
...
- Previous: [026 - Model warehouses, inventory balances, and stock movements](026-model-warehouses-inventory-balances-and-stock-movements.md)
- Next: [028 - Model payments, refunds, commissions, settlements, and payouts](028-model-payments-refunds-commissions-settlements-and-payouts.md)
...
- [x] The implementation of **Model carts, orders, seller fulfillment groups, and shipments** is real, reachable where intended, and contains no fake success path.
