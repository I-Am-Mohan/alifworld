...
milestone: 218
phase: 22
phase_name: "Lottery, Ads, Packages, and Affiliate Programs"
title: "Implement configurable subscription packages, caps, and validity"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 218: Implement configurable subscription packages, caps, and validity

## Outcome

Implement **Implement configurable subscription packages, caps, and validity** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 22, **Lottery, Ads, Packages, and Affiliate Programs**. The phase purpose is: Implement document-specified promotional modules as isolated, feature-gated capabilities subject to approval.
...
- Previous: [217 - Implement verified ad-view completion and anti-fraud controls](217-implement-verified-ad-view-completion-and-anti-fraud-controls.md)
- Next: [219 - Implement affiliate and package-referral commission levels](219-implement-affiliate-and-package-referral-commission-levels.md)
...
- Represent Free, Basic, Startup, Partner, Future, and Golden Future as Admin data with currency, price, validity, daily ad cap, and referral depth.
- Source USD values remain reference-only until BDT catalogue approval.
- Store price with explicit currency; source USD package values are not auto-converted to BDT.
- Enforce validity windows and daily caps on the server.

### Package catalogue transcribed from the marketing presentation

These values are source references in USD and remain inactive until an approved BDT catalogue exists.

| Package | Source price | Daily ad cap | Referral depth | Validity |
|---|---:|---:|---:|---:|
| Free Earn | USD 1 | 1 | 0 | 30 days |
| Basic | USD 10 | 4 | 2 | 30 days |
| Startup | USD 50 | 20 | 3 | 30 days |
| Partner 01 | USD 100 | 40 | 4 | 30 days |
| Partner 02 | USD 250 | 100 | 5 | 30 days |
| Partner 03 | USD 500 | 200 | 5 | 30 days |
| Partner 04 | USD 1,000 | 400 | 5 | 30 days |
| Future 1 | USD 100 | 10 | 5 | 200 days |
| Future 2 | USD 250 | 25 | 5 | 200 days |
| Future 3 | USD 500 | 50 | 5 | 200 days |
| Future 4 | USD 1,000 | 100 | 5 | 200 days |
| Golden Future | USD 2,000 | 200 | 5 | 200 days |

Admin must be able to create a Bangladesh BDT version without changing code. Package purchase, ad cap, referral depth, expiration, refund, cancellation, upgrade/downgrade, and eligibility rules must be versioned and snapshotted on subscription records.
...
Primary expected areas for this phase: `features/lottery, features/ads, features/packages, features/affiliate`. The exact existing repository structure wins when it already enforces the same boundaries. Do not create duplicate parallel modules merely to match a suggested path.
...
Phase-level test emphasis: wallet debit, draw audit, ad fraud, cap enforcement, legal gate and negative-path tests.
...
- [ ] The implementation of **Implement configurable subscription packages, caps, and validity** is real, reachable where intended, and contains no fake success path.
