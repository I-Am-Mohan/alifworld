...
title: "Implement compare-at, cost, minimum, and channel pricing"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
Implement **Implement compare-at, cost, minimum, and channel pricing** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 10, **Pricing, Tax, and Promotions**. The phase purpose is: Centralize all authoritative money calculations and preserve calculation snapshots.
...
- Previous: [091 - Define BDT pricing and immutable price snapshots](091-define-bdt-pricing-and-immutable-price-snapshots.md)
- Next: [093 - Implement configurable tax and VAT calculation architecture](093-implement-configurable-tax-and-vat-calculation-architecture.md)
...
- Support retail, B2B/wholesale, campaign, and negotiated price lists without duplicating product records.
- Model minimum order quantity, quantity breaks, effective dates, eligible buyer segments, and seller ownership.
...
- [ ] The implementation of **Implement compare-at, cost, minimum, and channel pricing** is real, reachable where intended, and contains no fake success path.
