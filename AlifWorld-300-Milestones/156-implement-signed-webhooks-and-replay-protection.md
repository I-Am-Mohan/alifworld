...
title: "Implement signed webhooks and replay protection"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 156: Implement signed webhooks and replay protection

## Outcome

Implement **Implement signed webhooks and replay protection** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 16, **Payments and Seller Finance**. The phase purpose is: Integrate payment providers behind stable interfaces and reconcile every external event.
...
- Previous: [155 - Implement payment intents, attempts, and idempotency](155-implement-payment-intents-attempts-and-idempotency.md)
- Next: [157 - Implement capture, failure recovery, and gateway reconciliation](157-implement-capture-failure-recovery-and-gateway-reconciliation.md)
...
- [ ] The implementation of **Implement signed webhooks and replay protection** is real, reachable where intended, and contains no fake success path.
