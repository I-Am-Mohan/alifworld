...
title: "Implement on-hand, reserved, available, damaged, and quarantine balances"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 102: Implement on-hand, reserved, available, damaged, and quarantine balances

## Outcome

Implement **Implement on-hand, reserved, available, damaged, and quarantine balances** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 11, **Inventory and Warehousing**. The phase purpose is: Prevent overselling and make every stock change auditable across sellers and locations.
...
- Previous: [101 - Implement warehouses and fulfillment locations](101-implement-warehouses-and-fulfillment-locations.md)
- Next: [103 - Implement the immutable stock-movement ledger](103-implement-the-immutable-stock-movement-ledger.md)
...
- [ ] The implementation of **Implement on-hand, reserved, available, damaged, and quarantine balances** is real, reachable where intended, and contains no fake success path.
