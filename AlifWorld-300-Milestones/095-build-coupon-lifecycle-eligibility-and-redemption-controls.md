...
title: "Build coupon lifecycle, eligibility, and redemption controls"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 095: Build coupon lifecycle, eligibility, and redemption controls

## Outcome

Implement **Build coupon lifecycle, eligibility, and redemption controls** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 10, **Pricing, Tax, and Promotions**. The phase purpose is: Centralize all authoritative money calculations and preserve calculation snapshots.
...
- Previous: [094 - Build the discount rule engine](094-build-the-discount-rule-engine.md)
- Next: [096 - Track seller-funded and platform-funded promotion attribution](096-track-seller-funded-and-platform-funded-promotion-attribution.md)
...
- [ ] The implementation of **Build coupon lifecycle, eligibility, and redemption controls** is real, reachable where intended, and contains no fake success path.
