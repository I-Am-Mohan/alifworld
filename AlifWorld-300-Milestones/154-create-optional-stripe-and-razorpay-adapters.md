...
title: "Create optional Stripe and Razorpay adapters"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 154: Create optional Stripe and Razorpay adapters

## Outcome

Implement **Create optional Stripe and Razorpay adapters** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 16, **Payments and Seller Finance**. The phase purpose is: Integrate payment providers behind stable interfaces and reconcile every external event.
...
- Previous: [153 - Create Bangladesh payment adapters for approved local gateways](153-create-bangladesh-payment-adapters-for-approved-local-gateways.md)
- Next: [155 - Implement payment intents, attempts, and idempotency](155-implement-payment-intents-attempts-and-idempotency.md)
...
- [ ] The implementation of **Create optional Stripe and Razorpay adapters** is real, reachable where intended, and contains no fake success path.
