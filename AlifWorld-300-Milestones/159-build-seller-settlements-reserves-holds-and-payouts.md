...
title: "Build seller settlements, reserves, holds, and payouts"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 159: Build seller settlements, reserves, holds, and payouts

## Outcome

Implement **Build seller settlements, reserves, holds, and payouts** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 16, **Payments and Seller Finance**. The phase purpose is: Integrate payment providers behind stable interfaces and reconcile every external event.
...
- Previous: [158 - Implement full, partial, and multi-item refunds](158-implement-full-partial-and-multi-item-refunds.md)
- Next: [160 - Complete financial reconciliation and payment integration tests](160-complete-financial-reconciliation-and-payment-integration-tests.md)
...
- [ ] The implementation of **Build seller settlements, reserves, holds, and payouts** is real, reachable where intended, and contains no fake success path.
