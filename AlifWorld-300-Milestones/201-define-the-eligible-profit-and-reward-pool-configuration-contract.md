...
title: "Define the eligible profit and reward-pool configuration contract"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 201: Define the eligible profit and reward-pool configuration contract

## Outcome

Implement **Define the eligible profit and reward-pool configuration contract** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 21, **Regional Distribution and Commissions**. The phase purpose is: Allocate rule-versioned Alif Point and Alif Pay commissions through Bangladesh geography.
...
- Previous: [200 - Build Seller reward reports, reconciliation, and acceptance tests](200-build-seller-reward-reports-reconciliation-and-acceptance-tests.md)
- Next: [202 - Implement period schedules, cutoffs, closing, and late-event handling](202-implement-period-schedules-cutoffs-closing-and-late-event-handling.md)
...
- Define gross sources, exclusions, returns, taxes, shipping, gateway fees, reserve, charity, service charges, and maximum distributable amount.
- Block Club/Star settlement when its pool contract is unapproved or underfunded.
...
- [ ] The implementation of **Define the eligible profit and reward-pool configuration contract** is real, reachable where intended, and contains no fake success path.
