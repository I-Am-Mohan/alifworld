...
title: "Implement the Customer 50-20-15-5-10 reward split"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 183: Implement the Customer 50-20-15-5-10 reward split

## Outcome

Implement **Implement the Customer 50-20-15-5-10 reward split** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 19, **Customer Rewards and Ranks**. The phase purpose is: Calculate configurable Customer rewards without conflating Club tiers, Star bands, and legacy career ranks.
...
- Previous: [182 - Implement referrals and the configurable 5 percent reference bonus](182-implement-referrals-and-the-configurable-5-pct-reference-bonus.md)
- Next: [184 - Configure Customer Club periods, tiers, and reference thresholds](184-configure-customer-club-periods-tiers-and-reference-thresholds.md)
...
- Apply Main 50%, Shopping 20%, Good-Luck 15%, Charity 5%, and Service Charge 10% as a seedable template.
- Shopping is purchase-only; Charity is view/report-only; Good-Luck funds approved ticket purchases.
...
- [ ] The implementation of **Implement the Customer 50-20-15-5-10 reward split** is real, reachable where intended, and contains no fake success path.
