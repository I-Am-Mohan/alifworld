...
milestone: 46
phase: 5
phase_name: "Authorization, Security, and Tenancy"
title: "Implement customer, rider, support, and system-service policies"
status: completed
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 046: Implement customer, rider, support, and system-service policies

## Outcome

Implement **Implement customer, rider, support, and system-service policies** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 05, **Authorization, Security, and Tenancy**. The phase purpose is: Enforce permissions and seller isolation on the server for every protected resource.
...
- Previous: [045 - Implement seller staff roles, invitations, and scoped access](045-implement-seller-staff-roles-invitations-and-scoped-access.md)
- Next: [047 - Add object-level authorization and ownership checks](047-add-object-level-authorization-and-ownership-checks.md)
...
Primary expected areas for this phase: `lib/authz, features/iam, middleware, audit, tests/security`. The exact existing repository structure wins when it already enforces the same boundaries. Do not create duplicate parallel modules merely to match a suggested path.
...
Phase-level test emphasis: role matrix, object authorization, cross-tenant denial, security-header tests.
...
- [x] The implementation of **Implement customer, rider, support, and system-service policies** is real, reachable where intended, and contains no fake success path.
