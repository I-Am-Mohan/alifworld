...
title: "Build CI pipelines for validation, build, test, scan, and artifacts"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 284: Build CI pipelines for validation, build, test, scan, and artifacts

## Outcome

Implement **Build CI pipelines for validation, build, test, scan, and artifacts** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 29, **DevOps, Deployment, and Observability**. The phase purpose is: Package, deploy, observe, and safely roll back the application and workers.
...
- Previous: [283 - Finalize environment files and the exact Bun command contract](283-finalize-environment-files-and-the-exact-bun-command-contract.md)
- Next: [285 - Automate safe migrations, seeds, and deployment ordering](285-automate-safe-migrations-seeds-and-deployment-ordering.md)
...
- [ ] The implementation of **Build CI pipelines for validation, build, test, scan, and artifacts** is real, reachable where intended, and contains no fake success path.
