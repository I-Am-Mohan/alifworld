...
- [ ] The implementation of **Configure linting, formatting, type checking, and commit quality** is real, reachable where intended, and contains no fake success path.
