...
title: "Create Bangladesh payment adapters for approved local gateways"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 153: Create Bangladesh payment adapters for approved local gateways

## Outcome

Implement **Create Bangladesh payment adapters for approved local gateways** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 16, **Payments and Seller Finance**. The phase purpose is: Integrate payment providers behind stable interfaces and reconcile every external event.
...
- Previous: [152 - Implement the Cash on Delivery provider](152-implement-the-cash-on-delivery-provider.md)
- Next: [154 - Create optional Stripe and Razorpay adapters](154-create-optional-stripe-and-razorpay-adapters.md)
...
- [ ] The implementation of **Create Bangladesh payment adapters for approved local gateways** is real, reachable where intended, and contains no fake success path.
