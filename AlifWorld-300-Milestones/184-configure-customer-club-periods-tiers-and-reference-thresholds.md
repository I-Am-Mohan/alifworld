...
title: "Configure Customer Club periods, tiers, and reference thresholds"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [183 - Implement the Customer 50-20-15-5-10 reward split](183-implement-the-customer-50-20-15-5-10-reward-split.md)
- Next: [185 - Implement equal-share Customer Club settlement](185-implement-equal-share-customer-club-settlement.md)
...
- Seed the documented Daily, Weekly, proposed Monthly, and Yearly Bronze/Silver/Gold thresholds.
- Keep the proposed Monthly slab disabled or visibly pending until its duplicated source label is confirmed.
- Evaluate Daily, Weekly, Monthly, and Yearly windows in Asia/Dhaka.
- A tier pool is shared equally among qualifying participants unless the approved matrix changes the method.
- Persist qualification evidence and the exact denominator.
...
- [ ] The implementation of **Configure Customer Club periods, tiers, and reference thresholds** is real, reachable where intended, and contains no fake success path.
