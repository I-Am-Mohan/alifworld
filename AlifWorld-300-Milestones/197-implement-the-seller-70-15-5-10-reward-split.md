...
title: "Implement the Seller 70-15-5-10 reward split"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 197: Implement the Seller 70-15-5-10 reward split

## Outcome

Implement **Implement the Seller 70-15-5-10 reward split** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 20, **Seller Rewards, Levels, and Leaderboards**. The phase purpose is: Reward seller performance through configured ledgers and auditable period settlements.
...
- Previous: [196 - Implement configurable Seller Rank Bonus and rank qualification](196-implement-configurable-seller-rank-bonus-and-rank-qualification.md)
- Next: [198 - Build Seller levels, badges, leaderboards, and progress UX](198-build-seller-levels-badges-leaderboards-and-progress-ux.md)
...
- Apply Main 70%, Good-Luck 15%, Charity 5%, and Service Charge 10% as a seedable Seller template.
- Only Main Wallet becomes payout-eligible after settlement and hold rules.
...
- [ ] The implementation of **Implement the Seller 70-15-5-10 reward split** is real, reachable where intended, and contains no fake success path.
