...
milestone: 207
phase: 21
phase_name: "Regional Distribution and Commissions"
title: "Implement Alif Pay regional and Service Point commission rules"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 207: Implement Alif Pay regional and Service Point commission rules

## Outcome

Implement **Implement Alif Pay regional and Service Point commission rules** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 21, **Regional Distribution and Commissions**. The phase purpose is: Allocate rule-versioned Alif Point and Alif Pay commissions through Bangladesh geography.
...
- Previous: [206 - Implement Alif Point Division, District, and Upazila commission rules](206-implement-alif-point-division-district-and-upazila-commission-rules.md)
- Next: [208 - Implement commission rounding, caps, reversals, and ledger posting](208-implement-commission-rounding-caps-reversals-and-ledger-posting.md)
...
- Seed Division 0.2%, District 0.3%, Upazila/Thana 0.5%, and Alif Service Point 1% as editable reference rates.
- Run only for transactions satisfying the approved Alif Pay eligibility condition.
...
Primary expected areas for this phase: `features/distribution, features/geography, workers/commission, app/admin/distribution`. The exact existing repository structure wins when it already enforces the same boundaries. Do not create duplicate parallel modules merely to match a suggested path.
...
Phase-level test emphasis: beneficiary mapping, rounding, hierarchy, correction runs, ledger reconciliation tests.
...
- [ ] The implementation of **Implement Alif Pay regional and Service Point commission rules** is real, reachable where intended, and contains no fake success path.
