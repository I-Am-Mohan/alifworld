...
title: "Implement commission rounding, caps, reversals, and ledger posting"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 208: Implement commission rounding, caps, reversals, and ledger posting

## Outcome

Implement **Implement commission rounding, caps, reversals, and ledger posting** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 21, **Regional Distribution and Commissions**. The phase purpose is: Allocate rule-versioned Alif Point and Alif Pay commissions through Bangladesh geography.
...
- Previous: [207 - Implement Alif Pay regional and Service Point commission rules](207-implement-alif-pay-regional-and-service-point-commission-rules.md)
- Next: [209 - Implement Charity Fund and Service Charge ledgers](209-implement-charity-fund-and-service-charge-ledgers.md)
...
- [ ] The implementation of **Implement commission rounding, caps, reversals, and ledger posting** is real, reachable where intended, and contains no fake success path.
