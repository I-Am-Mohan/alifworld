...
title: "Build lottery campaigns, ticket sales, and Good-Luck Wallet debits"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [211 - Design the Good-Luck lottery with a legal feature gate](211-design-the-good-luck-lottery-with-a-legal-feature-gate.md)
- Next: [213 - Implement auditable secure draws and winner publication](213-implement-auditable-secure-draws-and-winner-publication.md)
...
- Keep the module disabled until territory-specific legal approval is recorded.
- Use cryptographically secure randomness or an approved external draw procedure with immutable evidence.
- Never let an operator silently replace a winning result.
...
- [ ] The implementation of **Build lottery campaigns, ticket sales, and Good-Luck Wallet debits** is real, reachable where intended, and contains no fake success path.
