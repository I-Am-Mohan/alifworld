...
milestone: 196
phase: 20
phase_name: "Seller Rewards, Levels, and Leaderboards"
title: "Implement configurable Seller Rank Bonus and rank qualification"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 196: Implement configurable Seller Rank Bonus and rank qualification

## Outcome

Implement **Implement configurable Seller Rank Bonus and rank qualification** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 20, **Seller Rewards, Levels, and Leaderboards**. The phase purpose is: Reward seller performance through configured ledgers and auditable period settlements.
...
- Previous: [195 - Implement Seller Star reward-pool settlement](195-implement-seller-star-reward-pool-settlement.md)
- Next: [197 - Implement the Seller 70-15-5-10 reward split](197-implement-the-seller-70-15-5-10-reward-split.md)
...
- Seed a disabled 2% reference rate until the seller qualification trigger is approved.
- Allow configurable levels/ranks so sellers can progress from verified sales/Points without hard-coded marketing promises.
...
Primary expected areas for this phase: `features/rewards/seller, workers/leaderboards, app/seller/rewards`. The exact existing repository structure wins when it already enforces the same boundaries. Do not create duplicate parallel modules merely to match a suggested path.
...
Phase-level test emphasis: Club and Star qualification, tie rules, split, holds, reversals and reconciliation tests.
...
- [ ] The implementation of **Implement configurable Seller Rank Bonus and rank qualification** is real, reachable where intended, and contains no fake success path.
