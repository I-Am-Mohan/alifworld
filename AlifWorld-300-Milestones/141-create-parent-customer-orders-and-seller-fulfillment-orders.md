...
title: "Create parent customer orders and seller fulfillment orders"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 141: Create parent customer orders and seller fulfillment orders

## Outcome

Implement **Create parent customer orders and seller fulfillment orders** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 15, **Orders, Fulfillment, Returns, and Refunds**. The phase purpose is: Operate parent orders and seller-specific fulfillment with explicit state machines and compensation.
...
- Previous: [140 - Implement abandoned-checkout recovery and checkout acceptance tests](140-implement-abandoned-checkout-recovery-and-checkout-acceptance-tests.md)
- Next: [142 - Implement explicit order and fulfillment state machines](142-implement-explicit-order-and-fulfillment-state-machines.md)
...
- [ ] The implementation of **Create parent customer orders and seller fulfillment orders** is real, reachable where intended, and contains no fake success path.
