...
title: "Implement Seller wallet permissions and settlement restrictions"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 166: Implement Seller wallet permissions and settlement restrictions

## Outcome

Implement **Implement Seller wallet permissions and settlement restrictions** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 17, **Wallet Ledger**. The phase purpose is: Implement immutable balanced wallet accounting rather than mutable counters.
...
- Previous: [165 - Implement Customer wallet permissions and transfer restrictions](165-implement-customer-wallet-permissions-and-transfer-restrictions.md)
- Next: [167 - Build deposit and withdrawal request workflows](167-build-deposit-and-withdrawal-request-workflows.md)
...
- [ ] The implementation of **Implement Seller wallet permissions and settlement restrictions** is real, reachable where intended, and contains no fake success path.
