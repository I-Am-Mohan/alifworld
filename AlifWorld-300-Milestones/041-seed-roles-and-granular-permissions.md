...
title: "Seed roles and granular permissions"
status: completed
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 041: Seed roles and granular permissions

## Outcome

Implement **Seed roles and granular permissions** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 05, **Authorization, Security, and Tenancy**. The phase purpose is: Enforce permissions and seller isolation on the server for every protected resource.
...
- Previous: [040 - Complete authentication audits, rate limits, and integration tests](040-complete-authentication-audits-rate-limits-and-integration-tests.md)
- Next: [042 - Build the server-side authorization policy engine](042-build-the-server-side-authorization-policy-engine.md)
...
- [x] The implementation of **Seed roles and granular permissions** is real, reachable where intended, and contains no fake success path.
