...
title: "Implement password reset, password change, and breach-safe controls"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 037: Implement password reset, password change, and breach-safe controls

## Outcome

Implement **Implement password reset, password change, and breach-safe controls** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 04, **Identity and Authentication**. The phase purpose is: Deliver secure multi-role identity flows suitable for browsers and Flutter clients.
...
- Previous: [036 - Implement logout, revocation, session, and device management](036-implement-logout-revocation-session-and-device-management.md)
- Next: [038 - Design Bangladesh phone normalization and OTP authentication](038-design-bangladesh-phone-normalization-and-otp-authentication.md)
...
- [ ] The implementation of **Implement password reset, password change, and breach-safe controls** is real, reachable where intended, and contains no fake success path.
