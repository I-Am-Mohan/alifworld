...
milestone: 235
phase: 24
phase_name: "Admin, CMS, Support, and Analytics"
title: "Build payment, wallet, rewards, commission, and payout consoles"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 235: Build payment, wallet, rewards, commission, and payout consoles

## Outcome

Implement **Build payment, wallet, rewards, commission, and payout consoles** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 24, **Admin, CMS, Support, and Analytics**. The phase purpose is: Give authorized operators complete control without direct database manipulation.
...
- Previous: [234 - Build catalog, order, inventory, and delivery consoles](234-build-catalog-order-inventory-and-delivery-consoles.md)
- Next: [236 - Build CMS pages, banners, navigation, and homepage management](236-build-cms-pages-banners-navigation-and-homepage-management.md)
...
- Keep provider payloads behind an adapter and retain sanitized raw event references.
- Verify signatures before state changes and deduplicate webhook/event IDs.
- Reconcile gateway totals to order and ledger totals.
- Store payer, beneficiary, basis, rate, gross, net, rule version, source, and reversal link.
- Do not distribute more than the approved funded base.
...
Primary expected areas for this phase: `app/admin, features/admin, features/cms, features/support, features/analytics`. The exact existing repository structure wins when it already enforces the same boundaries. Do not create duplicate parallel modules merely to match a suggested path.
...
Phase-level test emphasis: permission variants, bulk safety, exports, config history, moderation and dashboard tests.
...
- [ ] The implementation of **Build payment, wallet, rewards, commission, and payout consoles** is real, reachable where intended, and contains no fake success path.
