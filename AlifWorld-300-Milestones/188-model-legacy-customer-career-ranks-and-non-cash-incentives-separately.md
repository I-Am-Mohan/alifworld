...
milestone: 188
phase: 19
phase_name: "Customer Rewards and Ranks"
title: "Model legacy Customer career ranks and non-cash incentives separately"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 188: Model legacy Customer career ranks and non-cash incentives separately

## Outcome

Implement **Model legacy Customer career ranks and non-cash incentives separately** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 19, **Customer Rewards and Ranks**. The phase purpose is: Calculate configurable Customer rewards without conflating Club tiers, Star bands, and legacy career ranks.
...
- Previous: [187 - Implement the configurable 3 percent Customer Rank Bonus](187-implement-the-configurable-3-pct-customer-rank-bonus.md)
- Next: [189 - Implement Advanced Shopping Wallet behind an approved-rule gate](189-implement-advanced-shopping-wallet-behind-an-approved-rule-gate.md)
...
- Keep Regular, General, Premium, Bronze, Silver, Gold, Star, Super Star, Platinum Executive, and Director as a configurable legacy career program.
- Do not merge those ranks with Club tiers or period Star leaderboard bands.
- Treat phones, vehicles, trips, salaries, and flats as fulfillment obligations requiring approval, budget, tax, and evidence, not instant wallet cash.
- Model rank definitions and qualification rules as data, with effective dates.
- Separate rank recognition, non-cash incentives, salary-like benefits, and ledger rewards.
- Leave unresolved formulas disabled until approved.
- Minimize personal data and enforce self-service ownership.
- Present BDT, Bangla/English copy, and accessible mobile-first states.

### Legacy career-rank reference - inactive until confirmed

The older client presentation contains the following career program. Preserve it as source data with an approval status; do not silently normalize ambiguous wording or activate benefits.

| Rank | Source condition | Source incentive / confirmation issue |
|---|---|---|
| Regular Customer | Purchase any one product | Key ring, T-shirt, and shopping bag |
| General Customer | Buy 10,000 Points and sell 20,000 Points | Key ring, T-shirt, mug (source text is unclear), and shopping bag |
| Premium Customer | Buy 50,000 Points and sell 1 lakh Points | Source says "2 no. with Cell Phone"; exact quantity/meaning requires confirmation |
| Bronze Customer | Buy 5 lakh Points, sell 10 lakh Points, and sell 5 lakh Points in Advanced Shopping | Source says "3 no." plus 12-month salary of BDT 5,000; meaning and funding require confirmation |
| Silver Customer | Buy 10 lakh Points, sell 50 lakh Points, and sell 25 lakh Points in Advanced Shopping | Source says "4 no." plus laptop and 12-month salary of BDT 10,000; meaning and funding require confirmation |
| Gold Customer | Buy 50 lakh Points and sell 2.5 crore Points; the source condition is visibly truncated | Source says "5 no." plus 150cc motorbike and 12-month salary of BDT 20,000; requires full confirmation |
| Star Customer | Create 10 Gold Customers in the referral team and reach 100 million team Points | Toyota Axio-class car, international tour, and 12-month salary of BDT 50,000 |
| Super Star Customer | Create 20 Star Customers in the referral team and reach 500 million team Points | Toyota Harrier-class car, international tour, and 12-month salary of BDT 100,000 |
| Platinum Executive | Create 50 Super Star Customers in the referral team and reach 250 crore team Points | Prado-class car, flat, international tour, and 12-month salary of BDT 500,000 |
| Director | Create 100 Platinum Executives in the referral team and reach 1,000 crore team Points | BMW-class car, flat, international tour, and 12-month salary of BDT 1,000,000 |

Store buy, personal-sale, team-sale, direct-rank-count, Advanced Shopping, and tenure conditions as separate composable predicates. Units in lakh/crore/million, ambiguous "no." phrases, incentive models, funding, tax, duration, substitution, and fulfilment require a signed configuration before activation.
...
Primary expected areas for this phase: `features/rewards/customer, workers/settlements, app/(store)/account/rewards`. The exact existing repository structure wins when it already enforces the same boundaries. Do not create duplicate parallel modules merely to match a suggested path.
...
### Source reference values - configuration, not constants

| Area | Initial reference |
|---|---|
| Customer reward split | Main 50%, Shopping 20%, Good-Luck 15%, Charity 5%, Service Charge 10% |
| Seller Club/Star split | Main 70%, Good-Luck 15%, Charity 5%, Service Charge 10% |
| Customer cashback / referral / rank bonus | 10% / 5% / 3% |
| Seller rank bonus | 2% |
| Star bands, each period | Mega Star positions 1-10, Super Star 11-50, Star 51-100; each band references 1% of its approved pool |
| Alif Point | Division 1%, District 2%, Upazila/Thana 3% |
| Alif Pay | Division 0.2%, District 0.3%, Upazila/Thana 0.5%, Service Point 1% |

Seller Club Point thresholds (Bronze/Silver/Gold, with reference pool shares 1%/2%/3%): Daily 10,000/30,000/100,000; Weekly 100,000/250,000/1,000,000; Monthly 500,000/1,500,000/5,000,000; Yearly 6,000,000/20,000,000/60,000,000.

Customer Club Point thresholds (Bronze/Silver/Gold, with reference pool shares 1%/2%/3%): Daily 3,000/4,000/5,000; Weekly 25,000/30,000/40,000; proposed Monthly 130,000/150,000/200,000 pending label confirmation; Yearly 1,600,000/2,000,000/2,500,000.

Validate every split sums to exactly 100% before activation. Store the applied rule-version identifier, input base, percentage, rounding result, source transaction, beneficiary, and reversal link on every posting.
...
Phase-level test emphasis: cashback, referral, split, equal-share settlement, rank separation, reversal tests.
...
- [ ] The implementation of **Model legacy Customer career ranks and non-cash incentives separately** is real, reachable where intended, and contains no fake success path.
