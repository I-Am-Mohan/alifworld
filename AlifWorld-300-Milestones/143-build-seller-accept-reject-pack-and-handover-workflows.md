...
title: "Build seller accept, reject, pack, and handover workflows"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 143: Build seller accept, reject, pack, and handover workflows

## Outcome

Implement **Build seller accept, reject, pack, and handover workflows** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 15, **Orders, Fulfillment, Returns, and Refunds**. The phase purpose is: Operate parent orders and seller-specific fulfillment with explicit state machines and compensation.
...
- Previous: [142 - Implement explicit order and fulfillment state machines](142-implement-explicit-order-and-fulfillment-state-machines.md)
- Next: [144 - Implement shipments, tracking numbers, and delivery events](144-implement-shipments-tracking-numbers-and-delivery-events.md)
...
- [ ] The implementation of **Build seller accept, reject, pack, and handover workflows** is real, reachable where intended, and contains no fake success path.
