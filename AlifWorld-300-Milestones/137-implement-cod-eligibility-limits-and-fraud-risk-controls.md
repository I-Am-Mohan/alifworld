...
title: "Implement COD eligibility, limits, and fraud-risk controls"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 137: Implement COD eligibility, limits, and fraud-risk controls

## Outcome

Implement **Implement COD eligibility, limits, and fraud-risk controls** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 14, **Checkout and Shipping**. The phase purpose is: Compute and commit a multi-seller checkout entirely on the server with Bangladesh-ready delivery.
...
- Previous: [136 - Calculate tax, discount, coupon, shipping, and points on the server](136-calculate-tax-discount-coupon-shipping-and-points-on-the-server.md)
- Next: [138 - Build payment-method discovery and selection](138-build-payment-method-discovery-and-selection.md)
...
- [ ] The implementation of **Implement COD eligibility, limits, and fraud-risk controls** is real, reachable where intended, and contains no fake success path.
