...
title: "Build the authoritative server-side pricing service"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 098: Build the authoritative server-side pricing service

## Outcome

Implement **Build the authoritative server-side pricing service** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 10, **Pricing, Tax, and Promotions**. The phase purpose is: Centralize all authoritative money calculations and preserve calculation snapshots.
...
- Previous: [097 - Implement promotion stacking, exclusion, and priority rules](097-implement-promotion-stacking-exclusion-and-priority-rules.md)
- Next: [099 - Implement scheduled prices and price-history visibility](099-implement-scheduled-prices-and-price-history-visibility.md)
...
- [ ] The implementation of **Build the authoritative server-side pricing service** is real, reachable where intended, and contains no fake success path.
