...
title: "Implement affiliate and package-referral commission levels"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [218 - Implement configurable subscription packages, caps, and validity](218-implement-configurable-subscription-packages-caps-and-validity.md)
- Next: [220 - Model marketing ranks and cash rewards behind compliance controls](220-model-marketing-ranks-and-cash-rewards-behind-compliance-controls.md)
...
- Support configurable package subscription reference levels 3%, 2%, and 1%, and ad-team reference levels 5%, 4%, 3%, 2%, and 1% only behind approval.
- Prevent cyclic graphs, self-referrals, identity farming, and payout beyond funded activity.
- Version the referral graph and prevent self-referral, cycles, duplicate identity, and retroactive reassignment.
- Gate multi-level payout rules behind compliance approval.
...
- [ ] The implementation of **Implement affiliate and package-referral commission levels** is real, reachable where intended, and contains no fake success path.
