...
milestone: 129
phase: 13
phase_name: "Customer Experience"
title: "Revalidate stock, price, points, coupons, and seller eligibility in cart"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 129: Revalidate stock, price, points, coupons, and seller eligibility in cart

## Outcome

Implement **Revalidate stock, price, points, coupons, and seller eligibility in cart** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 13, **Customer Experience**. The phase purpose is: Deliver account, engagement, trust, and cart journeys without leaking seller or customer data.
...
- Previous: [128 - Group cart contents by seller and fulfillment constraints](128-group-cart-contents-by-seller-and-fulfillment-constraints.md)
- Next: [130 - Build customer dashboards, order shortcuts, and notification preferences](130-build-customer-dashboards-order-shortcuts-and-notification-preferences.md)
...
- Make reservation expiry and retry behavior deterministic.
- Test concurrent attempts against the same final unit.
...
Primary expected areas for this phase: `features/customers, features/cart, features/reviews, app/(store)/account`. The exact existing repository structure wins when it already enforces the same boundaries. Do not create duplicate parallel modules merely to match a suggested path.
...
Phase-level test emphasis: guest merge, verified review, privacy, cart revalidation, responsive UI tests.
...
- [ ] The implementation of **Revalidate stock, price, points, coupons, and seller eligibility in cart** is real, reachable where intended, and contains no fake success path.
