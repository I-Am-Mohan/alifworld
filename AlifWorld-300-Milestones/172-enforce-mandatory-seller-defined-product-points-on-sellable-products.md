...
title: "Enforce mandatory seller-defined Product Points on sellable products"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 172: Enforce mandatory seller-defined Product Points on sellable products

## Outcome

Implement **Enforce mandatory seller-defined Product Points on sellable products** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 18, **Product Points Engine**. The phase purpose is: Treat Product Points as an independent, immutable, order-snapshotted unit with reversible ledger events.
...
- Previous: [171 - Define Product Point terminology, units, and invariants](171-define-product-point-terminology-units-and-invariants.md)
- Next: [173 - Snapshot Product Points on every order item](173-snapshot-product-points-on-every-order-item.md)
...
- [ ] The implementation of **Enforce mandatory seller-defined Product Points on sellable products** is real, reachable where intended, and contains no fake success path.
