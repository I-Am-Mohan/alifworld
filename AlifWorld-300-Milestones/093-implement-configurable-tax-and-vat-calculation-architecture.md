...
title: "Implement configurable tax and VAT calculation architecture"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 093: Implement configurable tax and VAT calculation architecture

## Outcome

Implement **Implement configurable tax and VAT calculation architecture** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 10, **Pricing, Tax, and Promotions**. The phase purpose is: Centralize all authoritative money calculations and preserve calculation snapshots.
...
- Previous: [092 - Implement compare-at, cost, minimum, and channel pricing](092-implement-compare-at-cost-minimum-and-channel-pricing.md)
- Next: [094 - Build the discount rule engine](094-build-the-discount-rule-engine.md)
...
- [ ] The implementation of **Implement configurable tax and VAT calculation architecture** is real, reachable where intended, and contains no fake success path.
