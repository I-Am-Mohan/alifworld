...
title: "Implement login and access-token issuance"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 034: Implement login and access-token issuance

## Outcome

Implement **Implement login and access-token issuance** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 04, **Identity and Authentication**. The phase purpose is: Deliver secure multi-role identity flows suitable for browsers and Flutter clients.
...
- Previous: [033 - Implement email verification and resend controls](033-implement-email-verification-and-resend-controls.md)
- Next: [035 - Implement rotating refresh-token families and reuse detection](035-implement-rotating-refresh-token-families-and-reuse-detection.md)
...
- [ ] The implementation of **Implement login and access-token issuance** is real, reachable where intended, and contains no fake success path.
