...
title: "Build Seller levels, badges, leaderboards, and progress UX"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 198: Build Seller levels, badges, leaderboards, and progress UX

## Outcome

Implement **Build Seller levels, badges, leaderboards, and progress UX** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 20, **Seller Rewards, Levels, and Leaderboards**. The phase purpose is: Reward seller performance through configured ledgers and auditable period settlements.
...
- Previous: [197 - Implement the Seller 70-15-5-10 reward split](197-implement-the-seller-70-15-5-10-reward-split.md)
- Next: [199 - Integrate Seller reward settlement, payout, hold, and reversal lifecycle](199-integrate-seller-reward-settlement-payout-hold-and-reversal-lifecycle.md)
...
- Define deterministic tie-breaking, eligibility, disqualification, and late-event policies.
- Freeze a period snapshot before payout and retain ranked inputs.
- Do not mix seller and customer boards or career ranks with Star bands.
...
- [ ] The implementation of **Build Seller levels, badges, leaderboards, and progress UX** is real, reachable where intended, and contains no fake success path.
