...
title: "Complete integration tests for cart, checkout, orders, and payments"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [273 - Complete integration tests for authentication and catalog](273-complete-integration-tests-for-authentication-and-catalog.md)
- Next: [275 - Complete integration tests for wallets, settlements, and commissions](275-complete-integration-tests-for-wallets-settlements-and-commissions.md)
...
- [ ] The implementation of **Complete integration tests for cart, checkout, orders, and payments** is real, reachable where intended, and contains no fake success path.
