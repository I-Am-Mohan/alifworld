...
title: "Implement Charity Fund and Service Charge ledgers"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 209: Implement Charity Fund and Service Charge ledgers

## Outcome

Implement **Implement Charity Fund and Service Charge ledgers** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 21, **Regional Distribution and Commissions**. The phase purpose is: Allocate rule-versioned Alif Point and Alif Pay commissions through Bangladesh geography.
...
- Previous: [208 - Implement commission rounding, caps, reversals, and ledger posting](208-implement-commission-rounding-caps-reversals-and-ledger-posting.md)
- Next: [210 - Build the Distribution Admin dashboard and end-to-end reconciliation](210-build-the-distribution-admin-dashboard-and-end-to-end-reconciliation.md)
...
- Treat Charity as a separately reportable ledger with approved beneficiary and transfer policy.
- Do not imply a donation has occurred until settlement evidence exists.
...
- [ ] The implementation of **Implement Charity Fund and Service Charge ledgers** is real, reachable where intended, and contains no fake success path.
