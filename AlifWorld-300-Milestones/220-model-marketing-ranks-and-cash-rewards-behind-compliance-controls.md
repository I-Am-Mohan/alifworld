...
title: "Model marketing ranks and cash rewards behind compliance controls"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [219 - Implement affiliate and package-referral commission levels](219-implement-affiliate-and-package-referral-commission-levels.md)
- Next: [221 - Build Rider application, KYC, and approval](221-build-rider-application-kyc-and-approval.md)
...
- Calculate from an explicitly named eligible base and versioned rule.
- Use deterministic rounding and store any residual policy.
- Settlement must be previewable, lockable, repeat-safe, and reconcilable.
...
### Marketing leadership reference - inactive until confirmed

| Rank | Source cash reward | Source team sales | Minimum team | Other source condition |
|---|---:|---:|---:|---|
| Marketing Officer | BDT 15,000 | USD 2,000 | 10 members | At least 3 active teams; source includes Team A 40% and other teams 30% wording |
| Supervisor | BDT 30,000 | USD 5,000 | 50 members | At least 3 active teams; same balance wording |
| Branch Manager | BDT 50,000 | USD 10,000 | 100 members | At least 3 active teams; same balance wording |

The USD team-sales basis, active-team definition, 40/30 balance rule, qualification window, recurrence, funding, clawback, and tax treatment are unresolved. Model them as disabled configurable predicates and benefit definitions. Do not promise or post a reward until the approved matrix and compliance gate are present.
...
- [ ] The implementation of **Model marketing ranks and cash rewards behind compliance controls** is real, reachable where intended, and contains no fake success path.
