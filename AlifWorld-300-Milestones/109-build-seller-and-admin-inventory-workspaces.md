...
milestone: 109
phase: 11
phase_name: "Inventory and Warehousing"
title: "Build Seller and Admin inventory workspaces"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 109: Build Seller and Admin inventory workspaces

## Outcome

Implement **Build Seller and Admin inventory workspaces** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 11, **Inventory and Warehousing**. The phase purpose is: Prevent overselling and make every stock change auditable across sellers and locations.
...
- Previous: [108 - Implement return restocking, inspection, and quarantine flows](108-implement-return-restocking-inspection-and-quarantine-flows.md)
- Next: [110 - Complete overselling, race-condition, and inventory reconciliation tests](110-complete-overselling-race-condition-and-inventory-reconciliation-tests.md)
...
Primary expected areas for this phase: `features/inventory, services/inventory, app/seller/inventory, app/admin/inventory`. The exact existing repository structure wins when it already enforces the same boundaries. Do not create duplicate parallel modules merely to match a suggested path.
...
Phase-level test emphasis: concurrency, reservation expiry, movement reconciliation, return disposition tests.
...
- [ ] The implementation of **Build Seller and Admin inventory workspaces** is real, reachable where intended, and contains no fake success path.
