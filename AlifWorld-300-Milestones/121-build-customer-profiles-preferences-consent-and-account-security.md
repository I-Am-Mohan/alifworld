...
title: "Build customer profiles, preferences, consent, and account security"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 121: Build customer profiles, preferences, consent, and account security

## Outcome

Implement **Build customer profiles, preferences, consent, and account security** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 13, **Customer Experience**. The phase purpose is: Deliver account, engagement, trust, and cart journeys without leaking seller or customer data.
...
- Previous: [120 - Complete sitemaps, robots, accessibility, and storefront performance](120-complete-sitemaps-robots-accessibility-and-storefront-performance.md)
- Next: [122 - Build the customer address book](122-build-the-customer-address-book.md)
...
- Support both individual Customers and approved Business Buyer organizations with explicit organization membership and permissions.
- Do not expose negotiated prices, credit limits, or organization orders to unrelated users.
...
- Document assets, actors, trust boundaries, abuse cases, and mitigations.
- Test denial paths and log security-relevant outcomes without sensitive data.
...
- [ ] The implementation of **Build customer profiles, preferences, consent, and account security** is real, reachable where intended, and contains no fake success path.
