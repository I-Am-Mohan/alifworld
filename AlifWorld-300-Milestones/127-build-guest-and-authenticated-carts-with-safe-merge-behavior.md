...
title: "Build guest and authenticated carts with safe merge behavior"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 127: Build guest and authenticated carts with safe merge behavior

## Outcome

Implement **Build guest and authenticated carts with safe merge behavior** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 13, **Customer Experience**. The phase purpose is: Deliver account, engagement, trust, and cart journeys without leaking seller or customer data.
...
- Previous: [126 - Implement product questions, seller answers, and moderation](126-implement-product-questions-seller-answers-and-moderation.md)
- Next: [128 - Group cart contents by seller and fulfillment constraints](128-group-cart-contents-by-seller-and-fulfillment-constraints.md)
...
- [ ] The implementation of **Build guest and authenticated carts with safe merge behavior** is real, reachable where intended, and contains no fake success path.
