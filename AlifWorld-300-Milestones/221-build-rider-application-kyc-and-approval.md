...
title: "Build Rider application, KYC, and approval"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 221: Build Rider application, KYC, and approval

## Outcome

Implement **Build Rider application, KYC, and approval** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 23, **Rider and Delivery**. The phase purpose is: Expose stable Flutter-ready Rider APIs and efficient delivery operations.
...
- Previous: [220 - Model marketing ranks and cash rewards behind compliance controls](220-model-marketing-ranks-and-cash-rewards-behind-compliance-controls.md)
- Next: [222 - Implement Rider authentication, profile, and availability status](222-implement-rider-authentication-profile-and-availability-status.md)
...
- [ ] The implementation of **Build Rider application, KYC, and approval** is real, reachable where intended, and contains no fake success path.
