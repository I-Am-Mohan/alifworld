...
title: "Implement explicit order and fulfillment state machines"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [141 - Create parent customer orders and seller fulfillment orders](141-create-parent-customer-orders-and-seller-fulfillment-orders.md)
- Next: [143 - Build seller accept, reject, pack, and handover workflows](143-build-seller-accept-reject-pack-and-handover-workflows.md)
...
- [ ] The implementation of **Implement explicit order and fulfillment state machines** is real, reachable where intended, and contains no fake success path.
