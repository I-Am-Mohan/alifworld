...
title: "Implement verified ad-view completion and anti-fraud controls"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [216 - Build the Alifworld.click advertisement library and campaign management](216-build-the-alifworld-click-advertisement-library-and-campaign-management.md)
- Next: [218 - Implement configurable subscription packages, caps, and validity](218-implement-configurable-subscription-packages-caps-and-validity.md)
...
### Advertisement-earning source reference - disabled by default

The marketing presentation references advertisements lasting 1-10 seconds, USD 0.10 per advertisement, and a phrase "Everyday earning: 4%." Treat all three as unapproved campaign/package configuration. The 4% base and meaning are undefined, and USD values must not be converted automatically for the Bangladesh launch. Require a funded campaign budget, anti-fraud checks, view verification, daily caps, settlement policy, and compliance approval before any earning is posted.
...
- [ ] The implementation of **Implement verified ad-view completion and anti-fraud controls** is real, reachable where intended, and contains no fake success path.
