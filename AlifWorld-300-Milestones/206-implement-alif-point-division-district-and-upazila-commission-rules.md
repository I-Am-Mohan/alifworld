...
title: "Implement Alif Point Division, District, and Upazila commission rules"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 206: Implement Alif Point Division, District, and Upazila commission rules

## Outcome

Implement **Implement Alif Point Division, District, and Upazila commission rules** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 21, **Regional Distribution and Commissions**. The phase purpose is: Allocate rule-versioned Alif Point and Alif Pay commissions through Bangladesh geography.
...
- Previous: [205 - Map merchants, customers, partners, and service points to beneficiaries](205-map-merchants-customers-partners-and-service-points-to-beneficiaries.md)
- Next: [207 - Implement Alif Pay regional and Service Point commission rules](207-implement-alif-pay-regional-and-service-point-commission-rules.md)
...
- Seed Division 1%, District 2%, and Upazila/Thana 3% as editable reference rates.
- Trace every commission to an eligible transaction and mapped beneficiary.
...
- [ ] The implementation of **Implement Alif Point Division, District, and Upazila commission rules** is real, reachable where intended, and contains no fake success path.
