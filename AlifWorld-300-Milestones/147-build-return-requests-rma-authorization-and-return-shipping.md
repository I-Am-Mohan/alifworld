...
title: "Build return requests, RMA authorization, and return shipping"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 147: Build return requests, RMA authorization, and return shipping

## Outcome

Implement **Build return requests, RMA authorization, and return shipping** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 15, **Orders, Fulfillment, Returns, and Refunds**. The phase purpose is: Operate parent orders and seller-specific fulfillment with explicit state machines and compensation.
...
- Previous: [146 - Implement item- and order-level cancellation policies](146-implement-item-and-order-level-cancellation-policies.md)
- Next: [148 - Build return inspection, disposition, and inventory decisions](148-build-return-inspection-disposition-and-inventory-decisions.md)
...
- [ ] The implementation of **Build return requests, RMA authorization, and return shipping** is real, reachable where intended, and contains no fake success path.
