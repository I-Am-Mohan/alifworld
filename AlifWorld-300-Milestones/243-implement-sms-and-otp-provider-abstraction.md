...
title: "Implement SMS and OTP provider abstraction"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 243: Implement SMS and OTP provider abstraction

## Outcome

Implement **Implement SMS and OTP provider abstraction** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 25, **Notifications, Jobs, and Realtime Events**. The phase purpose is: Move non-essential work to reliable queues and deliver localized multi-channel messages.
...
- Previous: [242 - Implement queued transactional email delivery](242-implement-queued-transactional-email-delivery.md)
- Next: [244 - Implement Firebase-compatible push notifications](244-implement-firebase-compatible-push-notifications.md)
...
- [ ] The implementation of **Implement SMS and OTP provider abstraction** is real, reachable where intended, and contains no fake success path.
