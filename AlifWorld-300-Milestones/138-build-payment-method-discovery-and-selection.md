...
title: "Build payment-method discovery and selection"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 138: Build payment-method discovery and selection

## Outcome

Implement **Build payment-method discovery and selection** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 14, **Checkout and Shipping**. The phase purpose is: Compute and commit a multi-seller checkout entirely on the server with Bangladesh-ready delivery.
...
- Previous: [137 - Implement COD eligibility, limits, and fraud-risk controls](137-implement-cod-eligibility-limits-and-fraud-risk-controls.md)
- Next: [139 - Build final order review, consent, and place-order transaction](139-build-final-order-review-consent-and-place-order-transaction.md)
...
- [ ] The implementation of **Build payment-method discovery and selection** is real, reachable where intended, and contains no fake success path.
