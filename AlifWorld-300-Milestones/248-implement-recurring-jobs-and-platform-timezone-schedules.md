...
title: "Implement recurring jobs and platform-timezone schedules"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 248: Implement recurring jobs and platform-timezone schedules

## Outcome

Implement **Implement recurring jobs and platform-timezone schedules** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 25, **Notifications, Jobs, and Realtime Events**. The phase purpose is: Move non-essential work to reliable queues and deliver localized multi-channel messages.
...
- Previous: [247 - Build BullMQ queue topology and separately scalable workers](247-build-bullmq-queue-topology-and-separately-scalable-workers.md)
- Next: [249 - Implement retries, deduplication, dead-letter handling, and job observability](249-implement-retries-deduplication-dead-letter-handling-and-job-observability.md)
...
- [ ] The implementation of **Implement recurring jobs and platform-timezone schedules** is real, reachable where intended, and contains no fake success path.
