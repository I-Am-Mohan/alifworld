...
title: "Implement rotating refresh-token families and reuse detection"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 035: Implement rotating refresh-token families and reuse detection

## Outcome

Implement **Implement rotating refresh-token families and reuse detection** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 04, **Identity and Authentication**. The phase purpose is: Deliver secure multi-role identity flows suitable for browsers and Flutter clients.
...
- Previous: [034 - Implement login and access-token issuance](034-implement-login-and-access-token-issuance.md)
- Next: [036 - Implement logout, revocation, session, and device management](036-implement-logout-revocation-session-and-device-management.md)
...
- [ ] The implementation of **Implement rotating refresh-token families and reuse detection** is real, reachable where intended, and contains no fake success path.
