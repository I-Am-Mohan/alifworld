...
title: "Define notification events, templates, preferences, and localization"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 241: Define notification events, templates, preferences, and localization

## Outcome

Implement **Define notification events, templates, preferences, and localization** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 25, **Notifications, Jobs, and Realtime Events**. The phase purpose is: Move non-essential work to reliable queues and deliver localized multi-channel messages.
...
- Previous: [240 - Build settings, feature flags, maintenance mode, and configuration history](240-build-settings-feature-flags-maintenance-mode-and-configuration-history.md)
- Next: [242 - Implement queued transactional email delivery](242-implement-queued-transactional-email-delivery.md)
...
- No user-facing string should be hard-coded in a component.
- Test English and Bangla expansion, fallback, pluralization, and locale-safe URLs.
...
- [ ] The implementation of **Define notification events, templates, preferences, and localization** is real, reachable where intended, and contains no fake success path.
