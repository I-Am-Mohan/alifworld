...
title: "Group cart contents by seller and fulfillment constraints"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 128: Group cart contents by seller and fulfillment constraints

## Outcome

Implement **Group cart contents by seller and fulfillment constraints** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 13, **Customer Experience**. The phase purpose is: Deliver account, engagement, trust, and cart journeys without leaking seller or customer data.
...
- Previous: [127 - Build guest and authenticated carts with safe merge behavior](127-build-guest-and-authenticated-carts-with-safe-merge-behavior.md)
- Next: [129 - Revalidate stock, price, points, coupons, and seller eligibility in cart](129-revalidate-stock-price-points-coupons-and-seller-eligibility-in-cart.md)
...
- [ ] The implementation of **Group cart contents by seller and fulfillment constraints** is real, reachable where intended, and contains no fake success path.
