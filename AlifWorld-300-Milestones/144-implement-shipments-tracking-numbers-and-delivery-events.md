...
title: "Implement shipments, tracking numbers, and delivery events"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [143 - Build seller accept, reject, pack, and handover workflows](143-build-seller-accept-reject-pack-and-handover-workflows.md)
- Next: [145 - Generate invoices, credit notes, and packing slips asynchronously](145-generate-invoices-credit-notes-and-packing-slips-asynchronously.md)
...
- [ ] The implementation of **Implement shipments, tracking numbers, and delivery events** is real, reachable where intended, and contains no fake success path.
