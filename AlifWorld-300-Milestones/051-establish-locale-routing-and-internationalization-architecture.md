...
title: "Establish locale routing and internationalization architecture"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
Implement **Establish locale routing and internationalization architecture** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 06, **Bangladesh Localization**. The phase purpose is: Make Bangladesh the first operational market while keeping locale, currency, and geography extensible.
...
- Previous: [050 - Complete the authorization and tenancy security test matrix](050-complete-the-authorization-and-tenancy-security-test-matrix.md)
- Next: [052 - Create English and Bangla translation catalogs](052-create-english-and-bangla-translation-catalogs.md)
...
- [ ] The implementation of **Establish locale routing and internationalization architecture** is real, reachable where intended, and contains no fake success path.
