...
title: "Implement full, partial, and multi-item refunds"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 158: Implement full, partial, and multi-item refunds

## Outcome

Implement **Implement full, partial, and multi-item refunds** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 16, **Payments and Seller Finance**. The phase purpose is: Integrate payment providers behind stable interfaces and reconcile every external event.
...
- Previous: [157 - Implement capture, failure recovery, and gateway reconciliation](157-implement-capture-failure-recovery-and-gateway-reconciliation.md)
- Next: [159 - Build seller settlements, reserves, holds, and payouts](159-build-seller-settlements-reserves-holds-and-payouts.md)
...
- [ ] The implementation of **Implement full, partial, and multi-item refunds** is real, reachable where intended, and contains no fake success path.
