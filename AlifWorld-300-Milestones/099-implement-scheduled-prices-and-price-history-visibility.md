...
title: "Implement scheduled prices and price-history visibility"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 099: Implement scheduled prices and price-history visibility

## Outcome

Implement **Implement scheduled prices and price-history visibility** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 10, **Pricing, Tax, and Promotions**. The phase purpose is: Centralize all authoritative money calculations and preserve calculation snapshots.
...
- Previous: [098 - Build the authoritative server-side pricing service](098-build-the-authoritative-server-side-pricing-service.md)
- Next: [100 - Complete pricing, rounding, boundary, and property-based tests](100-complete-pricing-rounding-boundary-and-property-based-tests.md)
...
- [ ] The implementation of **Implement scheduled prices and price-history visibility** is real, reachable where intended, and contains no fake success path.
