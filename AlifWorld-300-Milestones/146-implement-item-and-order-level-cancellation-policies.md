...
title: "Implement item- and order-level cancellation policies"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [145 - Generate invoices, credit notes, and packing slips asynchronously](145-generate-invoices-credit-notes-and-packing-slips-asynchronously.md)
- Next: [147 - Build return requests, RMA authorization, and return shipping](147-build-return-requests-rma-authorization-and-return-shipping.md)
...
- [ ] The implementation of **Implement item- and order-level cancellation policies** is real, reachable where intended, and contains no fake success path.
