...
title: "Implement configurable Customer cashback with a 10 percent reference rate"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 181: Implement configurable Customer cashback with a 10 percent reference rate

## Outcome

Implement **Implement configurable Customer cashback with a 10 percent reference rate** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 19, **Customer Rewards and Ranks**. The phase purpose is: Calculate configurable Customer rewards without conflating Club tiers, Star bands, and legacy career ranks.
...
- Previous: [180 - Build Point reconciliation, replay, and integrity diagnostics](180-build-point-reconciliation-replay-and-integrity-diagnostics.md)
- Next: [182 - Implement referrals and the configurable 5 percent reference bonus](182-implement-referrals-and-the-configurable-5-pct-reference-bonus.md)
...
- [ ] The implementation of **Implement configurable Customer cashback with a 10 percent reference rate** is real, reachable where intended, and contains no fake success path.
