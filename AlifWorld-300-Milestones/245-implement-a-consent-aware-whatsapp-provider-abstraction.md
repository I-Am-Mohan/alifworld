...
title: "Implement a consent-aware WhatsApp provider abstraction"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 245: Implement a consent-aware WhatsApp provider abstraction

## Outcome

Implement **Implement a consent-aware WhatsApp provider abstraction** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 25, **Notifications, Jobs, and Realtime Events**. The phase purpose is: Move non-essential work to reliable queues and deliver localized multi-channel messages.
...
- Previous: [244 - Implement Firebase-compatible push notifications](244-implement-firebase-compatible-push-notifications.md)
- Next: [246 - Build in-app notification inbox, read state, and pagination](246-build-in-app-notification-inbox-read-state-and-pagination.md)
...
- [ ] The implementation of **Implement a consent-aware WhatsApp provider abstraction** is real, reachable where intended, and contains no fake success path.
