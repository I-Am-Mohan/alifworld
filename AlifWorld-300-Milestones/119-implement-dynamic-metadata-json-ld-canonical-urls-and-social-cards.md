...
title: "Implement dynamic metadata, JSON-LD, canonical URLs, and social cards"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 119: Implement dynamic metadata, JSON-LD, canonical URLs, and social cards

## Outcome

Implement **Implement dynamic metadata, JSON-LD, canonical URLs, and social cards** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 12, **Search, Discovery, SEO, and Storefront**. The phase purpose is: Build fast localized discovery while keeping search optional and SEO first-class.
...
- Previous: [118 - Build public seller storefronts](118-build-public-seller-storefronts.md)
- Next: [120 - Complete sitemaps, robots, accessibility, and storefront performance](120-complete-sitemaps-robots-accessibility-and-storefront-performance.md)
...
- [ ] The implementation of **Implement dynamic metadata, JSON-LD, canonical URLs, and social cards** is real, reachable where intended, and contains no fake success path.
