...
title: "Configure Seller Club periods, tiers, and reference thresholds"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 192: Configure Seller Club periods, tiers, and reference thresholds

## Outcome

Implement **Configure Seller Club periods, tiers, and reference thresholds** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 20, **Seller Rewards, Levels, and Leaderboards**. The phase purpose is: Reward seller performance through configured ledgers and auditable period settlements.
...
- Previous: [191 - Implement Seller Total Sales and Total Point ledgers](191-implement-seller-total-sales-and-total-point-ledgers.md)
- Next: [193 - Implement equal-share Seller Club settlement](193-implement-equal-share-seller-club-settlement.md)
...
- [ ] The implementation of **Configure Seller Club periods, tiers, and reference thresholds** is real, reachable where intended, and contains no fake success path.
