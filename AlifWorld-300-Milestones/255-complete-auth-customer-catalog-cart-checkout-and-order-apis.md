...
milestone: 255
phase: 26
phase_name: "REST API, OpenAPI, and Flutter Contracts"
title: "Complete Auth, Customer, Catalog, Cart, Checkout, and Order APIs"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 255: Complete Auth, Customer, Catalog, Cart, Checkout, and Order APIs

## Outcome

Implement **Complete Auth, Customer, Catalog, Cart, Checkout, and Order APIs** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 26, **REST API, OpenAPI, and Flutter Contracts**. The phase purpose is: Make implementation-owned schemas produce stable versioned REST and automated documentation.
...
- Previous: [254 - Implement stable filtering, sorting, cursor, and page pagination contracts](254-implement-stable-filtering-sorting-cursor-and-page-pagination-contracts.md)
- Next: [256 - Complete Seller and Admin APIs with tenant-safe authorization](256-complete-seller-and-admin-apis-with-tenant-safe-authorization.md)
...
- Ignore client totals; recompute price, tax, shipping, discount, coupon, stock, seller status, and Points.
- Require an idempotency key for final placement.
...
Primary expected areas for this phase: `app/api/v1, validators, types, docs/api, app/api/docs, app/api/openapi.json`. The exact existing repository structure wins when it already enforces the same boundaries. Do not create duplicate parallel modules merely to match a suggested path.
...
Phase-level test emphasis: schema parity, response envelopes, examples, pagination, compatibility and generated-client checks.
...
- [ ] The implementation of **Complete Auth, Customer, Catalog, Cart, Checkout, and Order APIs** is real, reachable where intended, and contains no fake success path.
