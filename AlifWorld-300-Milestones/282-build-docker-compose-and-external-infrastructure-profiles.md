...
title: "Build Docker Compose and external-infrastructure profiles"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 282: Build Docker Compose and external-infrastructure profiles

## Outcome

Implement **Build Docker Compose and external-infrastructure profiles** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 29, **DevOps, Deployment, and Observability**. The phase purpose is: Package, deploy, observe, and safely roll back the application and workers.
...
- Previous: [281 - Build the production multi-stage Docker image](281-build-the-production-multi-stage-docker-image.md)
- Next: [283 - Finalize environment files and the exact Bun command contract](283-finalize-environment-files-and-the-exact-bun-command-contract.md)
...
- [ ] The implementation of **Build Docker Compose and external-infrastructure profiles** is real, reachable where intended, and contains no fake success path.
