...
title: "Implement Firebase-compatible push notifications"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 244: Implement Firebase-compatible push notifications

## Outcome

Implement **Implement Firebase-compatible push notifications** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 25, **Notifications, Jobs, and Realtime Events**. The phase purpose is: Move non-essential work to reliable queues and deliver localized multi-channel messages.
...
- Previous: [243 - Implement SMS and OTP provider abstraction](243-implement-sms-and-otp-provider-abstraction.md)
- Next: [245 - Implement a consent-aware WhatsApp provider abstraction](245-implement-a-consent-aware-whatsapp-provider-abstraction.md)
...
- [ ] The implementation of **Implement Firebase-compatible push notifications** is real, reachable where intended, and contains no fake success path.
