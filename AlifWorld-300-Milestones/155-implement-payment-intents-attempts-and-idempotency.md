...
title: "Implement payment intents, attempts, and idempotency"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 155: Implement payment intents, attempts, and idempotency

## Outcome

Implement **Implement payment intents, attempts, and idempotency** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 16, **Payments and Seller Finance**. The phase purpose is: Integrate payment providers behind stable interfaces and reconcile every external event.
...
- Previous: [154 - Create optional Stripe and Razorpay adapters](154-create-optional-stripe-and-razorpay-adapters.md)
- Next: [156 - Implement signed webhooks and replay protection](156-implement-signed-webhooks-and-replay-protection.md)
...
- [ ] The implementation of **Implement payment intents, attempts, and idempotency** is real, reachable where intended, and contains no fake success path.
