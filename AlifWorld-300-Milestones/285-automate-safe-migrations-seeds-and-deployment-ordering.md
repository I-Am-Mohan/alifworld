...
milestone: 285
phase: 29
phase_name: "DevOps, Deployment, and Observability"
title: "Automate safe migrations, seeds, and deployment ordering"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 285: Automate safe migrations, seeds, and deployment ordering

## Outcome

Implement **Automate safe migrations, seeds, and deployment ordering** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 29, **DevOps, Deployment, and Observability**. The phase purpose is: Package, deploy, observe, and safely roll back the application and workers.
...
- Previous: [284 - Build CI pipelines for validation, build, test, scan, and artifacts](284-build-ci-pipelines-for-validation-build-test-scan-and-artifacts.md)
- Next: [286 - Define preview, staging, and production topology](286-define-preview-staging-and-production-topology.md)
...
- Prefer expand-and-contract changes and test against production-like volume.
- Take backups and define rollback/forward-fix behavior before destructive schema changes.
...
Primary expected areas for this phase: `Dockerfile, docker, .github or CI config, instrumentation, docs/runbooks`. The exact existing repository structure wins when it already enforces the same boundaries. Do not create duplicate parallel modules merely to match a suggested path.
...
Phase-level test emphasis: container build, migration safety, health checks, telemetry, alert drills and rollback tests.
...
- [ ] The implementation of **Automate safe migrations, seeds, and deployment ordering** is real, reachable where intended, and contains no fake success path.
