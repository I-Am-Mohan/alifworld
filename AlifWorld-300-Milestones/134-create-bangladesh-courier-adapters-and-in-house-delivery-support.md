...
title: "Create Bangladesh courier adapters and in-house delivery support"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 134: Create Bangladesh courier adapters and in-house delivery support

## Outcome

Implement **Create Bangladesh courier adapters and in-house delivery support** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 14, **Checkout and Shipping**. The phase purpose is: Compute and commit a multi-seller checkout entirely on the server with Bangladesh-ready delivery.
...
- Previous: [133 - Create the shipping-rate and promise abstraction](133-create-the-shipping-rate-and-promise-abstraction.md)
- Next: [135 - Build seller-level shipment groups for multi-vendor checkout](135-build-seller-level-shipment-groups-for-multi-vendor-checkout.md)
...
- [ ] The implementation of **Create Bangladesh courier adapters and in-house delivery support** is real, reachable where intended, and contains no fake success path.
