...
title: "Build seller-level shipment groups for multi-vendor checkout"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 135: Build seller-level shipment groups for multi-vendor checkout

## Outcome

Implement **Build seller-level shipment groups for multi-vendor checkout** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 14, **Checkout and Shipping**. The phase purpose is: Compute and commit a multi-seller checkout entirely on the server with Bangladesh-ready delivery.
...
- Previous: [134 - Create Bangladesh courier adapters and in-house delivery support](134-create-bangladesh-courier-adapters-and-in-house-delivery-support.md)
- Next: [136 - Calculate tax, discount, coupon, shipping, and points on the server](136-calculate-tax-discount-coupon-shipping-and-points-on-the-server.md)
...
- [ ] The implementation of **Build seller-level shipment groups for multi-vendor checkout** is real, reachable where intended, and contains no fake success path.
