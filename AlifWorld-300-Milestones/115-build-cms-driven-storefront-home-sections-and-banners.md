...
title: "Build CMS-driven storefront home sections and banners"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 115: Build CMS-driven storefront home sections and banners

## Outcome

Implement **Build CMS-driven storefront home sections and banners** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 12, **Search, Discovery, SEO, and Storefront**. The phase purpose is: Build fast localized discovery while keeping search optional and SEO first-class.
...
- Previous: [114 - Implement PostgreSQL search fallback and graceful degradation](114-implement-postgresql-search-fallback-and-graceful-degradation.md)
- Next: [116 - Build category, brand, and collection landing pages](116-build-category-brand-and-collection-landing-pages.md)
...
- [ ] The implementation of **Build CMS-driven storefront home sections and banners** is real, reachable where intended, and contains no fake success path.
