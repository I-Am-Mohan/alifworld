...
title: "Implement delivery failure, cancellation, return, and cash collection"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 228: Implement delivery failure, cancellation, return, and cash collection

## Outcome

Implement **Implement delivery failure, cancellation, return, and cash collection** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 23, **Rider and Delivery**. The phase purpose is: Expose stable Flutter-ready Rider APIs and efficient delivery operations.
...
- Previous: [227 - Implement customer OTP and proof-of-delivery completion](227-implement-customer-otp-and-proof-of-delivery-completion.md)
- Next: [229 - Build Rider earnings, history, and reconciliation](229-build-rider-earnings-history-and-reconciliation.md)
...
- [ ] The implementation of **Implement delivery failure, cancellation, return, and cash collection** is real, reachable where intended, and contains no fake success path.
