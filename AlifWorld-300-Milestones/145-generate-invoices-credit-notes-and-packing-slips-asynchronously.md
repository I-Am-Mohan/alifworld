...
title: "Generate invoices, credit notes, and packing slips asynchronously"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 145: Generate invoices, credit notes, and packing slips asynchronously

## Outcome

Implement **Generate invoices, credit notes, and packing slips asynchronously** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 15, **Orders, Fulfillment, Returns, and Refunds**. The phase purpose is: Operate parent orders and seller-specific fulfillment with explicit state machines and compensation.
...
- Previous: [144 - Implement shipments, tracking numbers, and delivery events](144-implement-shipments-tracking-numbers-and-delivery-events.md)
- Next: [146 - Implement item- and order-level cancellation policies](146-implement-item-and-order-level-cancellation-policies.md)
...
- [ ] The implementation of **Generate invoices, credit notes, and packing slips asynchronously** is real, reachable where intended, and contains no fake success path.
