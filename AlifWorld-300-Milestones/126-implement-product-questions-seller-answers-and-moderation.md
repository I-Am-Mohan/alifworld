...
title: "Implement product questions, seller answers, and moderation"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 126: Implement product questions, seller answers, and moderation

## Outcome

Implement **Implement product questions, seller answers, and moderation** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 13, **Customer Experience**. The phase purpose is: Deliver account, engagement, trust, and cart journeys without leaking seller or customer data.
...
- Previous: [125 - Implement verified-purchase reviews, ratings, and review media](125-implement-verified-purchase-reviews-ratings-and-review-media.md)
- Next: [127 - Build guest and authenticated carts with safe merge behavior](127-build-guest-and-authenticated-carts-with-safe-merge-behavior.md)
...
- [ ] The implementation of **Implement product questions, seller answers, and moderation** is real, reachable where intended, and contains no fake success path.
