...
title: "Model users, roles, permissions, and role assignments"
status: completed
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 023: Model users, roles, permissions, and role assignments

## Outcome

Implement **Model users, roles, permissions, and role assignments** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 03, **Data Architecture**. The phase purpose is: Build a production PostgreSQL/Prisma model that preserves history, tenant boundaries, and financial traceability.
...
- Previous: [022 - Standardize identifiers, timestamps, lifecycle fields, and deletion policy](022-standardize-identifiers-timestamps-lifecycle-fields-and-deletion-policy.md)
- Next: [024 - Model sellers, seller staff, KYC documents, and store settings](024-model-sellers-seller-staff-kyc-documents-and-store-settings.md)
...
- [x] The implementation of **Model users, roles, permissions, and role assignments** is real, reachable where intended, and contains no fake success path.
