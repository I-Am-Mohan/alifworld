...
title: "Build category, brand, and collection landing pages"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 116: Build category, brand, and collection landing pages

## Outcome

Implement **Build category, brand, and collection landing pages** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 12, **Search, Discovery, SEO, and Storefront**. The phase purpose is: Build fast localized discovery while keeping search optional and SEO first-class.
...
- Previous: [115 - Build CMS-driven storefront home sections and banners](115-build-cms-driven-storefront-home-sections-and-banners.md)
- Next: [117 - Build the localized product detail and variant-selection experience](117-build-the-localized-product-detail-and-variant-selection-experience.md)
...
- [ ] The implementation of **Build category, brand, and collection landing pages** is real, reachable where intended, and contains no fake success path.
