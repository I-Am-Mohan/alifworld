...
title: "Define preview, staging, and production topology"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 286: Define preview, staging, and production topology

## Outcome

Implement **Define preview, staging, and production topology** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 29, **DevOps, Deployment, and Observability**. The phase purpose is: Package, deploy, observe, and safely roll back the application and workers.
...
- Previous: [285 - Automate safe migrations, seeds, and deployment ordering](285-automate-safe-migrations-seeds-and-deployment-ordering.md)
- Next: [287 - Implement structured logs and request correlation](287-implement-structured-logs-and-request-correlation.md)
...
- [ ] The implementation of **Define preview, staging, and production topology** is real, reachable where intended, and contains no fake success path.
