...
title: "Import and maintain Bangladesh geographic hierarchy"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 204: Import and maintain Bangladesh geographic hierarchy

## Outcome

Implement **Import and maintain Bangladesh geographic hierarchy** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 21, **Regional Distribution and Commissions**. The phase purpose is: Allocate rule-versioned Alif Point and Alif Pay commissions through Bangladesh geography.
...
- Previous: [203 - Implement versioned settlements, reruns, locks, and correction runs](203-implement-versioned-settlements-reruns-locks-and-correction-runs.md)
- Next: [205 - Map merchants, customers, partners, and service points to beneficiaries](205-map-merchants-customers-partners-and-service-points-to-beneficiaries.md)
...
- [ ] The implementation of **Import and maintain Bangladesh geographic hierarchy** is real, reachable where intended, and contains no fake success path.
