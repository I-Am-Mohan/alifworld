...
title: "Generate Points only at the configured eligible order status"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 174: Generate Points only at the configured eligible order status

## Outcome

Implement **Generate Points only at the configured eligible order status** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 18, **Product Points Engine**. The phase purpose is: Treat Product Points as an independent, immutable, order-snapshotted unit with reversible ledger events.
...
- Previous: [173 - Snapshot Product Points on every order item](173-snapshot-product-points-on-every-order-item.md)
- Next: [175 - Reverse Points safely for cancellation, return, and quantity changes](175-reverse-points-safely-for-cancellation-return-and-quantity-changes.md)
...
- [ ] The implementation of **Generate Points only at the configured eligible order status** is real, reachable where intended, and contains no fake success path.
