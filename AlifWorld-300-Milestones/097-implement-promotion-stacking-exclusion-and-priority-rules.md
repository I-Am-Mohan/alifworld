...
title: "Implement promotion stacking, exclusion, and priority rules"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 097: Implement promotion stacking, exclusion, and priority rules

## Outcome

Implement **Implement promotion stacking, exclusion, and priority rules** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 10, **Pricing, Tax, and Promotions**. The phase purpose is: Centralize all authoritative money calculations and preserve calculation snapshots.
...
- Previous: [096 - Track seller-funded and platform-funded promotion attribution](096-track-seller-funded-and-platform-funded-promotion-attribution.md)
- Next: [098 - Build the authoritative server-side pricing service](098-build-the-authoritative-server-side-pricing-service.md)
...
- [ ] The implementation of **Implement promotion stacking, exclusion, and priority rules** is real, reachable where intended, and contains no fake success path.
