...
title: "Implement low-stock thresholds, alerts, and reorder views"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 106: Implement low-stock thresholds, alerts, and reorder views

## Outcome

Implement **Implement low-stock thresholds, alerts, and reorder views** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 11, **Inventory and Warehousing**. The phase purpose is: Prevent overselling and make every stock change auditable across sellers and locations.
...
- Previous: [105 - Implement reservation release, commit, expiry, and compensation](105-implement-reservation-release-commit-expiry-and-compensation.md)
- Next: [107 - Implement transfers, counts, corrections, and approval controls](107-implement-transfers-counts-corrections-and-approval-controls.md)
...
- [ ] The implementation of **Implement low-stock thresholds, alerts, and reorder views** is real, reachable where intended, and contains no fake success path.
