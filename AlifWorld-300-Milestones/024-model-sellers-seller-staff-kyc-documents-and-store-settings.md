...
title: "Model sellers, seller staff, KYC documents, and store settings"
status: completed
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 024: Model sellers, seller staff, KYC documents, and store settings

## Outcome

Implement **Model sellers, seller staff, KYC documents, and store settings** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 03, **Data Architecture**. The phase purpose is: Build a production PostgreSQL/Prisma model that preserves history, tenant boundaries, and financial traceability.
...
- Previous: [023 - Model users, roles, permissions, and role assignments](023-model-users-roles-permissions-and-role-assignments.md)
- Next: [025 - Model catalog taxonomy, products, variants, and media](025-model-catalog-taxonomy-products-variants-and-media.md)
...
- [x] The implementation of **Model sellers, seller staff, KYC documents, and store settings** is real, reachable where intended, and contains no fake success path.
