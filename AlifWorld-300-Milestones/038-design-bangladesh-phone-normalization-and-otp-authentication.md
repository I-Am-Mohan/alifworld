...
title: "Design Bangladesh phone normalization and OTP authentication"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
Implement **Design Bangladesh phone normalization and OTP authentication** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 04, **Identity and Authentication**. The phase purpose is: Deliver secure multi-role identity flows suitable for browsers and Flutter clients.
...
- Previous: [037 - Implement password reset, password change, and breach-safe controls](037-implement-password-reset-password-change-and-breach-safe-controls.md)
- Next: [039 - Add Google and Apple authentication provider architecture](039-add-google-and-apple-authentication-provider-architecture.md)
...
- [ ] The implementation of **Design Bangladesh phone normalization and OTP authentication** is real, reachable where intended, and contains no fake success path.
