...
title: "Build the Redis connection, namespace, and cache abstraction"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 261: Build the Redis connection, namespace, and cache abstraction

## Outcome

Implement **Build the Redis connection, namespace, and cache abstraction** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 27, **Caching, Performance, Scale, and Resilience**. The phase purpose is: Prove that the stateless application can scale horizontally and degrade safely.
...
- Previous: [260 - Generate typed clients and enforce Flutter-compatible API evolution](260-generate-typed-clients-and-enforce-flutter-compatible-api-evolution.md)
- Next: [262 - Define cache keys, TTLs, tags, invalidation, and stampede protection](262-define-cache-keys-ttls-tags-invalidation-and-stampede-protection.md)
...
- Name keys with versioned namespaces and tenant/locale dimensions.
- Invalidate from committed domain events and protect hot keys from stampedes.
...
- [ ] The implementation of **Build the Redis connection, namespace, and cache abstraction** is real, reachable where intended, and contains no fake success path.
