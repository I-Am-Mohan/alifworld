...
title: "Implement referrals and the configurable 5 percent reference bonus"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 182: Implement referrals and the configurable 5 percent reference bonus

## Outcome

Implement **Implement referrals and the configurable 5 percent reference bonus** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 19, **Customer Rewards and Ranks**. The phase purpose is: Calculate configurable Customer rewards without conflating Club tiers, Star bands, and legacy career ranks.
...
- Previous: [181 - Implement configurable Customer cashback with a 10 percent reference rate](181-implement-configurable-customer-cashback-with-a-10-pct-reference-rate.md)
- Next: [183 - Implement the Customer 50-20-15-5-10 reward split](183-implement-the-customer-50-20-15-5-10-reward-split.md)
...
- [ ] The implementation of **Implement referrals and the configurable 5 percent reference bonus** is real, reachable where intended, and contains no fake success path.
