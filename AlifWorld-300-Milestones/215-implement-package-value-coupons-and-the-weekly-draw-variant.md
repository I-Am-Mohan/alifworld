...
title: "Implement package-value coupons and the weekly draw variant"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
- Previous: [214 - Implement prize fulfillment and completed-lottery history](214-implement-prize-fulfillment-and-completed-lottery-history.md)
- Next: [216 - Build the Alifworld.click advertisement library and campaign management](216-build-the-alifworld-click-advertisement-library-and-campaign-management.md)
...
- Model the source weekly Friday 10:30 PM and one coupon per USD 10 only as an inactive reference.
- For Bangladesh launch, require an approved BDT package/coupon rule instead of live exchange conversion.
- Close sales before draw execution and commit the eligible ticket set hash.
- Publish enough evidence for audit without exposing private customer data.
...
- Reserve/redemption counters transactionally and reverse them by policy.
- Define time zone, user, seller, product, minimum-spend, stack, and usage limits.
...
- [ ] The implementation of **Implement package-value coupons and the weekly draw variant** is real, reachable where intended, and contains no fake success path.
