...
title: "Implement balance projections, holds, and available-balance rules"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 164: Implement balance projections, holds, and available-balance rules

## Outcome

Implement **Implement balance projections, holds, and available-balance rules** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 17, **Wallet Ledger**. The phase purpose is: Implement immutable balanced wallet accounting rather than mutable counters.
...
- Previous: [163 - Implement balanced transactions and immutable postings](163-implement-balanced-transactions-and-immutable-postings.md)
- Next: [165 - Implement Customer wallet permissions and transfer restrictions](165-implement-customer-wallet-permissions-and-transfer-restrictions.md)
...
- [ ] The implementation of **Implement balance projections, holds, and available-balance rules** is real, reachable where intended, and contains no fake success path.
