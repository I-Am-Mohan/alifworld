...
title: "Track seller-funded and platform-funded promotion attribution"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 096: Track seller-funded and platform-funded promotion attribution

## Outcome

Implement **Track seller-funded and platform-funded promotion attribution** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 10, **Pricing, Tax, and Promotions**. The phase purpose is: Centralize all authoritative money calculations and preserve calculation snapshots.
...
- Previous: [095 - Build coupon lifecycle, eligibility, and redemption controls](095-build-coupon-lifecycle-eligibility-and-redemption-controls.md)
- Next: [097 - Implement promotion stacking, exclusion, and priority rules](097-implement-promotion-stacking-exclusion-and-priority-rules.md)
...
- [ ] The implementation of **Track seller-funded and platform-funded promotion attribution** is real, reachable where intended, and contains no fake success path.
