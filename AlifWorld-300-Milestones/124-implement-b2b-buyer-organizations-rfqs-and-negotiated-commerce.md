...
title: "Implement B2B buyer organizations, RFQs, and negotiated commerce"
status: not-started
currency: BDT
locales: [en-BD, bn-BD]
timezone: Asia/Dhaka
...
# Milestone 124: Implement B2B buyer organizations, RFQs, and negotiated commerce

## Outcome

Implement **Implement B2B buyer organizations, RFQs, and negotiated commerce** as a production-ready, tested part of AlifWorld. This milestone belongs to Phase 13, **Customer Experience**. The phase purpose is: Deliver account, engagement, trust, and cart journeys without leaking seller or customer data.
...
- Previous: [123 - Implement wishlists and share-safe wishlist links](123-implement-wishlists-and-share-safe-wishlist-links.md)
- Next: [125 - Implement verified-purchase reviews, ratings, and review media](125-implement-verified-purchase-reviews-ratings-and-review-media.md)
...
- Model Business Buyer applications, organizations, members, RFQs, quote versions, seller responses, expiry, acceptance, and conversion to cart/order.
- Support MOQ, quantity breaks, purchase-order references, and approval workflows; credit terms remain disabled until explicitly approved.
- Define whether each B2B transaction earns Product Points/rewards in versioned configuration rather than assuming retail rules.
...
- [ ] The implementation of **Implement B2B buyer organizations, RFQs, and negotiated commerce** is real, reachable where intended, and contains no fake success path.
